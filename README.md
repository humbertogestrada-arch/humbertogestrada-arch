...
Focus: Fintech, Sports Analytics, and Logistics Optimization.
...
* **Business:** Product Strategy, Unit Economics, B2B SaaS, Risk Management.

---

### Featured Projects (Portfolio)

#### Asesor FutBot (SaaS) - *Proprietary / In Production*
...
* **Algorithms:** Fraud detection using Benford's Law and blacklist cross-referencing.
* **Output:** Automated generation of financial executive reports (PDF/Excel).

#### HFT Crypto Arbitrage - *Proprietary / Private Repo*
High-Frequency Trading system for triangular arbitrage.
* **Engineering:** Low-latency microservices deployed in Tokyo (Vultr).
* **Innovation:** "Topological Defense" (TDA) for market risk management.
* **Tech:** AsyncIO, WebSockets, Directed Graphs.
